...
class Hyperparameters:
    ...
    num_iterations : int = 60 # safety upper bound on steps; the real stop is the time budget below
    ...
    val_evals : int = 0 # validations spread evenly through the run (a final eval at the stop always runs too)
