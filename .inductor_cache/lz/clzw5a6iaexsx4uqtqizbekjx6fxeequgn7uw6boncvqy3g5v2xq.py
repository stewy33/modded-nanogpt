...
#   %add_10 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_14, %mul_18), kwargs = {})
#   %convert_element_type_32 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_10, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/modded-nanogpt/.inductor_cache/db/cdbveewqb4fsezv6plamjgu6dmnhjx6z7uyrjpykidfhstuq6ip5.py
...
#   %add_11 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_10, %mul_22), kwargs = {})
...
#   %add_12 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_11, %mul_26), kwargs = {})
#   %convert_element_type_46 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_12, torch.bfloat16), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'in_ptr1': '*fp32', 'in_ptr2': '*bf16', 'in_ptr3': '*fp32', 'in_ptr4': '*fp32', 'in_ptr5': '*fp32', 'in_ptr6': '*fp32', 'in_ptr7': '*fp32', 'out_ptr1': '*fp32', 'out_ptr2': '*bf16', 'xnumel': 'i32', 'r0_numel': 'i32'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]], (10,): [['tt.divisibility', 16]], (11,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_div_mul_pow_sum_view_3', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': True, 'num_load': 8, 'num_reduction': 1, 'backend_hash': '0E240AAAE3E9D1980383EC2FCF1E55EF51BD69D1F11DF86C6B99F17FF7E9B37A', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 1572864, 'r0_': 2818572288}}
)
@triton.jit
def triton_per_fused__to_copy_add_div_mul_pow_sum_view_3(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, out_ptr1, out_ptr2, xnumel, r0_numel):
    xnumel = 131072
    XBLOCK: tl.constexpr = 1
    r0_numel = 768
    R0_BLOCK: tl.constexpr = 1024
    ...
    tmp11 = tl.load(in_ptr3 + (r0_1 + 768*x0), r0_mask, other=0.0)
    tmp12 = tl.load(in_ptr4 + (x0), None, eviction_policy='evict_last')
    tmp14 = tl.load(in_ptr5 + (x0), None, eviction_policy='evict_last')
    tmp22 = tl.load(in_ptr6 + (r0_1 + 768*x0), r0_mask, other=0.0)
    ...
    tl.store(out_ptr1 + (r0_1 + 768*x0), tmp37, r0_mask)
...
# Source node to ATen node mapping:
#   neg => neg
#   rms_norm_45 => convert_element_type_18
# Graph fragment:
...
#   %add_13 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_27, %mul_29), kwargs = {})
#   %mul_30 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%slice_9, %unsqueeze_1), kwargs = {})
#   %add_14 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_28, %mul_30), kwargs = {})
...
#   %convert_element_type_52 : [num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_15, torch.float32), kwargs = {})
...
#   %add_19 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_36, %mul_40), kwargs = {})
#   %convert_element_type_53 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_19, torch.bfloat16), kwargs = {})
...
#   %add_21 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_60, %convert_element_type_66), kwargs = {})
...
#   %add_22 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_21, %convert_element_type_72), kwargs = {})
...
def call(args):
    primals_7, view, mm, mm_1, convert_element_type_14, convert_element_type_15, rsqrt, rsqrt_1, permute_3, permute_4, permute_5, getitem, getitem_1, getitem_6, getitem_7, mm_3, rsqrt_2, view_13, mm_4, view_15, add_8, rsqrt_3, permute_12, permute_16, permute_20, permute_28, permute_32, permute_36, tangents_1 = args
    args.clear()
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        extern_kernels.mm(reinterpret_tensor(buf1, (768, 131072), (1, 768), 0), view_15, out=buf2)
        del view_15
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf5, (3072, 131072), (1, 3072), 0), view_13, out=buf6)
        del view_13
        ...
        del buf6
        buf10 = empty_strided_cuda((128, 1024, 768), (786432, 768, 1), torch.float32)
        buf11 = empty_strided_cuda((131072, 768), (768, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [add_4], Original ATen: [aten.mul, aten.div, aten.pow, aten.add, aten._to_copy, aten.sum, aten.view]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_div_mul_pow_sum_view_3.run(buf7, primals_7, mm_3, tangents_1, rsqrt_3, buf0, add_8, rsqrt_2, buf10, buf11, 131072, 768, stream=stream0)
        del add_8
        del buf0
        del mm_3
        del primals_7
        ...
        # Topologically Sorted Source Nodes: [neg, rms_norm_45], Original ATen: [aten.mul, aten.neg, aten.add, aten.slice_backward, aten._to_copy, aten.sum, aten.div, aten.pow]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_div_mul_neg_pow_slice_backward_sum_5.run(buf26, buf17, convert_element_type_14, convert_element_type_15, rsqrt_1, 786432, 128, stream=stream0)
        del buf17
        del rsqrt_1
        ...
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_div_mul_neg_pow_slice_backward_sum_5.run(buf30, buf16, convert_element_type_14, convert_element_type_15, rsqrt, 786432, 128, stream=stream0)
        ...
        del buf31
    return (buf33, buf34, buf29, buf25, None, buf14, buf10, buf8, buf4, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    fn = lambda: call([primals_7, view, mm, mm_1, convert_element_type_14, convert_element_type_15, rsqrt, rsqrt_1, permute_3, permute_4, permute_5, getitem, getitem_1, getitem_6, getitem_7, mm_3, rsqrt_2, view_13, mm_4, view_15, add_8, rsqrt_3, permute_12, permute_16, permute_20, permute_28, permute_32, permute_36, tangents_1])
