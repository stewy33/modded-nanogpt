...
# kernel path: /workspace/modded-nanogpt/.inductor_cache/mh/cmhzsxi5cuspcisnx7gnuxj3fvkxudp3525ervduvld56g26qjz5.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.mul, aten.sum, aten.add, aten.div, aten.pow, aten._to_copy, aten.view]
# Source node to ATen node mapping:
# Graph fragment:
#   %mul_13 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tangents_1, %add_8), kwargs = {})
#   %mul_14 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tangents_1, %rsqrt_3), kwargs = {})
#   %sum_1 : [num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_13, [2], True), kwargs = {dtype: torch.float32})
#   %add_10 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%tangents_2, %mul_14), kwargs = {})
...
#   %mul_17 : [num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%pow_7, 2.0), kwargs = {})
#   %mul_18 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, %mul_17), kwargs = {})
#   %add_11 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_10, %mul_18), kwargs = {})
#   %convert_element_type_32 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_11, torch.bfloat16), kwargs = {})
#   %view_17 : [num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%convert_element_type_32, [131072, 768]), kwargs = {})
triton_per_fused__to_copy_add_div_mul_pow_sum_view_0 = async_compile.triton('triton_per_fused__to_copy_add_div_mul_pow_sum_view_0', '''
import triton
import triton.language as tl
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'out_ptr1': '*fp32', 'out_ptr2': '*bf16', 'xnumel': 'i32', 'r0_numel': 'i32'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_div_mul_pow_sum_view_0', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': True, 'num_load': 4, 'num_reduction': 1, 'backend_hash': '0E240AAAE3E9D1980383EC2FCF1E55EF51BD69D1F11DF86C6B99F17FF7E9B37A', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 524288, 'r0_': 2415919104}}
)
@triton.jit
def triton_per_fused__to_copy_add_div_mul_pow_sum_view_0(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr1, out_ptr2, xnumel, r0_numel):
    xnumel = 131072
    ...
    tmp7 = tl.load(in_ptr2 + (r0_1 + 768*x0), r0_mask, other=0.0)
    ...
    tl.store(out_ptr1 + (r0_1 + 768*x0), tmp21, r0_mask)
    tl.store(out_ptr2 + (r0_1 + 768*x0), tmp22, r0_mask)
''', device_str='cuda')
...
# Source node to ATen node mapping:
# Graph fragment:
#   %convert_element_type_38 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_6, torch.float32), kwargs = {})
...
# Source node to ATen node mapping:
#   relu => relu
#   square => convert_element_type_27
# Graph fragment:
#   %convert_element_type_37 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_18, torch.float32), kwargs = {})
...
#   %pow_8 : [num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_27, 1.0), kwargs = {})
#   %mul_19 : [num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%pow_8, 2.0), kwargs = {})
#   %mul_20 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_37, %mul_19), kwargs = {})
#   %convert_element_type_39 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_20, torch.bfloat16), kwargs = {})
...
#   %where : [num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%le, %full_default, %convert_element_type_39), kwargs = {})
...
# kernel path: /workspace/modded-nanogpt/.inductor_cache/pw/cpwcrpxod2gbmlennwvekcehoilm63fscfzk7x4goacjmkjfg6e4.py
# Topologically Sorted Source Nodes: [add_4], Original ATen: [aten._to_copy, aten.add, aten.mul, aten.sum, aten.div, aten.pow, aten.view]
# Source node to ATen node mapping:
#   add_4 => add_6
# Graph fragment:
#   %convert_element_type_44 : [num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_20, torch.float32), kwargs = {})
#   %add_6 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%primals_7, %view_12), kwargs = {})
#   %mul_21 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_44, %add_6), kwargs = {})
#   %mul_22 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_44, %rsqrt_2), kwargs = {})
#   %sum_2 : [num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_21, [2], True), kwargs = {dtype: torch.float32})
#   %add_12 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_11, %mul_22), kwargs = {})
...
#   %mul_25 : [num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%pow_10, 2.0), kwargs = {})
#   %mul_26 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_1, %mul_25), kwargs = {})
#   %add_13 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_12, %mul_26), kwargs = {})
#   %convert_element_type_46 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_13, torch.bfloat16), kwargs = {})
#   %view_21 : [num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%convert_element_type_46, [131072, 768]), kwargs = {})
...
# Source node to ATen node mapping:
# Graph fragment:
#   %convert_element_type_51 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_10, torch.float32), kwargs = {})
...
# Topologically Sorted Source Nodes: [neg, rms_norm_41], Original ATen: [aten.mul, aten.neg, aten.add, aten.slice_backward, aten._to_copy, aten.sum, aten.div, aten.pow]
# Source node to ATen node mapping:
#   neg => neg
#   rms_norm_41 => convert_element_type_18
# Graph fragment:
#   %mul_27 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%slice_10, %unsqueeze_1), kwargs = {})
#   %neg : [num_users=2] = call_function[target=torch.ops.aten.neg.default](args = (%unsqueeze_3,), kwargs = {})
#   %mul_28 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%slice_10, %neg), kwargs = {})
#   %mul_29 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%slice_9, %unsqueeze_3), kwargs = {})
#   %add_14 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_27, %mul_29), kwargs = {})
#   %mul_30 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%slice_9, %unsqueeze_1), kwargs = {})
#   %add_15 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_28, %mul_30), kwargs = {})
...
#   %slice_scatter_default : [num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default_1, %add_14, 3, 64, 9223372036854775807), kwargs = {})
#   %slice_scatter_default_1 : [num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default_1, %add_15, 3, 0, 64), kwargs = {})
#   %add_16 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default, %slice_scatter_default_1), kwargs = {})
#   %convert_element_type_52 : [num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_16, torch.float32), kwargs = {})
...
#   %mul_35 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_52, %convert_element_type_18), kwargs = {})
#   %mul_36 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_52, %rsqrt_1), kwargs = {})
#   %sum_3 : [num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_35, [3], True), kwargs = {dtype: torch.float32})
#   %div_2 : [num_users=1] = call_function[target=torch.ops.aten.div.Scalar](args = (%expand_2, 128), kwargs = {})
#   %pow_12 : [num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_18, 1.0), kwargs = {})
#   %mul_39 : [num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%pow_12, 2.0), kwargs = {})
#   %mul_40 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_2, %mul_39), kwargs = {})
#   %add_20 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_36, %mul_40), kwargs = {})
#   %convert_element_type_53 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_20, torch.bfloat16), kwargs = {})
...
# Source node to ATen node mapping:
# Graph fragment:
#   %convert_element_type_60 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_26, torch.float32), kwargs = {})
#   %convert_element_type_66 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_29, torch.float32), kwargs = {})
#   %add_22 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_60, %convert_element_type_66), kwargs = {})
#   %convert_element_type_72 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_32, torch.float32), kwargs = {})
#   %add_23 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_22, %convert_element_type_72), kwargs = {})
...
def call(args):
    primals_7, view, mm, mm_1, convert_element_type_14, convert_element_type_15, rsqrt, rsqrt_1, permute_3, permute_4, permute_5, getitem, getitem_1, getitem_6, getitem_7, mm_3, rsqrt_2, view_13, mm_4, view_15, add_8, rsqrt_3, permute_12, permute_16, permute_20, permute_28, permute_32, permute_36, tangents_1, tangents_2 = args
    args.clear()
    ...
    assert_size_stride(convert_element_type_14, (1024, 64), (64, 1))
    assert_size_stride(convert_element_type_15, (1024, 64), (64, 1))
    ...
    assert_size_stride(view_13, (131072, 768), (768, 1))
    assert_size_stride(mm_4, (131072, 3072), (3072, 1))
    assert_size_stride(view_15, (131072, 3072), (3072, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf1 = empty_strided_cuda((128, 1024, 768), (786432, 768, 1), torch.float32)
        buf2 = empty_strided_cuda((131072, 768), (768, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mul, aten.sum, aten.add, aten.div, aten.pow, aten._to_copy, aten.view]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_div_mul_pow_sum_view_0.run(tangents_1, add_8, tangents_2, rsqrt_3, buf1, buf2, 131072, 768, stream=stream0)
        del add_8
        del rsqrt_3
        del tangents_1
        del tangents_2
        buf3 = empty_strided_cuda((768, 3072), (3072, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf2, (768, 131072), (1, 768), 0), view_15, out=buf3)
        del view_15
        buf4 = empty_strided_cuda((131072, 3072), (3072, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(buf2, permute_12, out=buf4)
        del permute_12
        buf5 = empty_strided_cuda((768, 3072), (3072, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_1.run(buf3, buf5, 2359296, stream=stream0)
        buf6 = reinterpret_tensor(buf4, (128, 1024, 3072), (3145728, 3072, 1), 0); del buf4  # reuse
        # Topologically Sorted Source Nodes: [relu, square], Original ATen: [aten._to_copy, aten.relu, aten.pow, aten.mul, aten.threshold_backward]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_mul_pow_relu_threshold_backward_2.run(buf6, mm_4, 402653184, stream=stream0)
        del mm_4
        buf7 = reinterpret_tensor(buf3, (3072, 768), (768, 1), 0); del buf3  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf6, (3072, 131072), (1, 3072), 0), view_13, out=buf7)
        del view_13
        buf8 = buf2; del buf2  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf6, (131072, 3072), (3072, 1), 0), permute_16, out=buf8)
        del buf6
        del permute_16
        buf9 = empty_strided_cuda((3072, 768), (768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_1.run(buf7, buf9, 2359296, stream=stream0)
        del buf7
        buf11 = buf1; del buf1  # reuse
        buf12 = empty_strided_cuda((131072, 768), (768, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [add_4], Original ATen: [aten._to_copy, aten.add, aten.mul, aten.sum, aten.div, aten.pow, aten.view]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_div_mul_pow_sum_view_3.run(buf11, buf8, primals_7, mm_3, rsqrt_2, buf12, 131072, 768, stream=stream0)
        del mm_3
        del primals_7
        del rsqrt_2
        buf13 = empty_strided_cuda((768, 768), (768, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf12, (768, 131072), (1, 768), 0), reinterpret_tensor(getitem, (131072, 768), (768, 1), 0), out=buf13)
        buf14 = buf8; del buf8  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(buf12, permute_20, out=buf14)
        del buf12
        del permute_20
        buf15 = empty_strided_cuda((768, 768), (768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_4.run(buf13, buf15, 589824, stream=stream0)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_flash_attention_backward]
        buf16 = torch.ops.aten._scaled_dot_product_flash_attention_backward.default(reinterpret_tensor(buf14, (128, 6, 1024, 128), (786432, 128, 768, 1), 0), permute_3, permute_4, permute_5, getitem, getitem_1, None, None, 1024, 1024, 0.0, True, getitem_6, getitem_7, scale=0.08838834764831843)
        del buf14
        del getitem
        del getitem_1
        del getitem_6
        ...
        buf19 = buf16[2]
        assert_size_stride(buf19, (128, 6, 1024, 128), (786432, 128, 768, 1), 'torch.ops.aten._scaled_dot_product_flash_attention_backward.default')
        assert_alignment(buf19, 16, 'torch.ops.aten._scaled_dot_product_flash_attention_backward.default')
        del buf16
        buf27 = reinterpret_tensor(mm_1, (128, 1024, 6, 128), (786432, 768, 128, 1), 0); del mm_1  # reuse
        # Topologically Sorted Source Nodes: [neg, rms_norm_41], Original ATen: [aten.mul, aten.neg, aten.add, aten.slice_backward, aten._to_copy, aten.sum, aten.div, aten.pow]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_div_mul_neg_pow_slice_backward_sum_5.run(buf27, buf18, convert_element_type_14, convert_element_type_15, rsqrt_1, 786432, 128, stream=stream0)
        del buf18
        del rsqrt_1
        buf31 = reinterpret_tensor(mm, (128, 1024, 6, 128), (786432, 768, 128, 1), 0); del mm  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_div_mul_neg_pow_slice_backward_sum_5.run(buf31, buf17, convert_element_type_14, convert_element_type_15, rsqrt, 786432, 128, stream=stream0)
        del convert_element_type_14
        del convert_element_type_15
        del rsqrt
        buf24 = buf13; del buf13  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf19, (768, 131072), (1, 768), 0), view, out=buf24)
        buf25 = reinterpret_tensor(buf17, (131072, 768), (768, 1), 0); del buf17  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf19, (131072, 768), (768, 1), 0), permute_28, out=buf25)
        del permute_28
        buf26 = empty_strided_cuda((768, 768), (768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_4.run(buf24, buf26, 589824, stream=stream0)
        buf28 = buf24; del buf24  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf27, (768, 131072), (1, 768), 0), view, out=buf28)
        buf29 = reinterpret_tensor(buf19, (131072, 768), (768, 1), 0); del buf19  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf27, (131072, 768), (768, 1), 0), permute_32, out=buf29)
        del permute_32
        buf30 = empty_strided_cuda((768, 768), (768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_4.run(buf28, buf30, 589824, stream=stream0)
        buf32 = buf28; del buf28  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf31, (768, 131072), (1, 768), 0), view, out=buf32)
        del view
        buf33 = reinterpret_tensor(buf27, (131072, 768), (768, 1), 0); del buf27  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf31, (131072, 768), (768, 1), 0), permute_36, out=buf33)
        del buf31
        del permute_36
        buf34 = empty_strided_cuda((128, 1024, 768), (786432, 768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_add_6.run(buf25, buf29, buf33, buf34, 100663296, stream=stream0)
        del buf25
        del buf29
        del buf33
        buf35 = empty_strided_cuda((768, 768), (768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_4.run(buf32, buf35, 589824, stream=stream0)
        del buf32
    return (buf34, buf35, buf30, buf26, None, buf15, buf11, buf9, buf5, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    convert_element_type_14 = rand_strided((1024, 64), (64, 1), device='cuda:0', dtype=torch.bfloat16)
    convert_element_type_15 = rand_strided((1024, 64), (64, 1), device='cuda:0', dtype=torch.bfloat16)
    ...
    view_13 = rand_strided((131072, 768), (768, 1), device='cuda:0', dtype=torch.bfloat16)
    mm_4 = rand_strided((131072, 3072), (3072, 1), device='cuda:0', dtype=torch.bfloat16)
    view_15 = rand_strided((131072, 3072), (3072, 1), device='cuda:0', dtype=torch.bfloat16)
    ...
    fn = lambda: call([primals_7, view, mm, mm_1, convert_element_type_14, convert_element_type_15, rsqrt, rsqrt_1, permute_3, permute_4, permute_5, getitem, getitem_1, getitem_6, getitem_7, mm_3, rsqrt_2, view_13, mm_4, view_15, add_8, rsqrt_3, permute_12, permute_16, permute_20, permute_28, permute_32, permute_36, tangents_1, tangents_2])
