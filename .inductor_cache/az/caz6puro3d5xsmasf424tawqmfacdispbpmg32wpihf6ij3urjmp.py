...
#   cat => cat
#   cat_1 => cat_1
#   rms_norm => add, convert_element_type_16, mean, pow_1, rsqrt
#   rms_norm_45 => add_1, convert_element_type_18, mean_1, pow_2, rsqrt_1
# Graph fragment:
...
#   rms_norm_46 => add_7, mean_2, mul_11, pow_3, rsqrt_2
# Graph fragment:
...
#   add_4 => add_6
#   add_5 => add_8
#   rms_norm_47 => add_9, mean_3, mul_12, pow_5, rsqrt_3
# Graph fragment:
#   %add_6 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%primals_7, %view_12), kwargs = {})
