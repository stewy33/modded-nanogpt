...
# kernel path: /workspace/modded-nanogpt/.inductor_cache/j6/cj6p3pfgsbvx2wujprkkylxjdomxb7ryldub3pt7obj2sm2bee73.py
...
# Graph fragment:
#   %convert_element_type : [num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg2_1, torch.bfloat16), kwargs = {})
...
@triton.jit
def triton_red_fused__to_copy_linalg_vector_norm_0(in_ptr0, out_ptr0, ks0, ks1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 288
    rnumel = r0_numel
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        rindex = r0_index
        r0_1 = r0_index
        tmp0 = r0_1 + x0*((287 + ks0*ks1) // 288)
        tmp1 = ks0*ks1
        tmp2 = tmp0 < tmp1
        tmp3 = tl.load(in_ptr0 + (((r0_1 + x0*((287 + ks0*ks1) // 288)) % (ks0*ks1))), r0_mask & tmp2 & xmask, eviction_policy='evict_last', other=0.0)
...
# kernel path: /workspace/modded-nanogpt/.inductor_cache/6c/c6cvapuywdad7utkt4lzonc5i4wswlrleag7ghosmv2h4k3um3q3.py
...
#   %div : [num_users=4] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type, %add_3), kwargs = {})
...
# kernel path: /workspace/modded-nanogpt/.inductor_cache/tl/ctl5guj5ibvvomvfgspfr7akmaclkd3ewm5ig5mtzg3zqir4w4iy.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/modded-nanogpt/.inductor_cache/jl/cjlkprz7xmh7b72ivgoke5vj3jj4s3rrk3fp55cpzalqvd5w34of.py
...
#   mul_1 => mul_15
# Graph fragment:
#   %mul_12 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, 3.4445), kwargs = {})
#   %mul_15 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mm_1, -4.775), kwargs = {})
#   %add_25 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_12, %mul_15), kwargs = {})
...
def call(args):
    ...
    s85 = arg0_1
    s36 = arg1_1
    assert_size_stride(arg2_1, (s85, s36), (s36, 1))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf1 = empty_strided_cuda((288, ), (1, ), torch.float32)
        # Topologically Sorted Source Nodes: [X, norm], Original ATen: [aten._to_copy, aten.linalg_vector_norm]
        triton_red_fused__to_copy_linalg_vector_norm_0_r0_numel = (287 + s36*s85) // 288
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_linalg_vector_norm_0.run(arg2_1, buf1, s36, s85, 288, triton_red_fused__to_copy_linalg_vector_norm_0_r0_numel, stream=stream0)
        buf2 = empty_strided_cuda((), (), torch.float32)
        # Topologically Sorted Source Nodes: [X, norm], Original ATen: [aten._to_copy, aten.linalg_vector_norm]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_linalg_vector_norm_1.run(buf1, buf2, 1, 288, stream=stream0)
        del buf1
        buf3 = empty_strided_cuda((s85, s36), (s36, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [X, norm, add, X_1], Original ATen: [aten._to_copy, aten.linalg_vector_norm, aten.add, aten.div]
        triton_poi_fused__to_copy_add_div_linalg_vector_norm_2_xnumel = s36*s85
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_add_div_linalg_vector_norm_2.run(arg2_1, buf2, buf3, triton_poi_fused__to_copy_add_div_linalg_vector_norm_2_xnumel, stream=stream0)
        del arg2_1
        del buf2
        buf4 = empty_strided_cuda((s85, s85), (s85, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [A], Original ATen: [aten.mm]
        extern_kernels.mm(buf3, reinterpret_tensor(buf3, (s36, s85), (1, s36), 0), out=buf4)
        buf5 = empty_strided_cuda((s85, s36), (s36, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [B], Original ATen: [aten.mm]
        extern_kernels.mm(buf4, buf3, out=buf5)
        buf6 = buf4; del buf4  # reuse
        # Topologically Sorted Source Nodes: [mul_2], Original ATen: [aten.mul]
        triton_poi_fused_mul_3_xnumel = s85*s85
        stream0 = get_raw_stream(0)
        triton_poi_fused_mul_3.run(buf6, triton_poi_fused_mul_3_xnumel, stream=stream0)
        buf7 = buf3; del buf3  # reuse
        # Topologically Sorted Source Nodes: [mul, mul_1, add_1], Original ATen: [aten.mul, aten.add]
        triton_poi_fused_add_mul_4_xnumel = s36*s85
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_mul_4.run(buf7, buf5, triton_poi_fused_add_mul_4_xnumel, stream=stream0)
        buf8 = empty_strided_cuda((s85, s36), (s36, 1), torch.bfloat16)
        ...
        extern_kernels.mm(buf8, reinterpret_tensor(buf8, (s36, s85), (1, s36), 0), out=buf9)
        ...
        triton_poi_fused_mul_3_xnumel = s85*s85
        stream0 = get_raw_stream(0)
        triton_poi_fused_mul_3.run(buf11, triton_poi_fused_mul_3_xnumel, stream=stream0)
        buf12 = buf8; del buf8  # reuse
        # Topologically Sorted Source Nodes: [mul_3, mul_4, add_3], Original ATen: [aten.mul, aten.add]
        triton_poi_fused_add_mul_4_xnumel = s36*s85
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_mul_4.run(buf12, buf10, triton_poi_fused_add_mul_4_xnumel, stream=stream0)
        ...
        extern_kernels.mm(buf13, reinterpret_tensor(buf13, (s36, s85), (1, s36), 0), out=buf14)
        ...
        triton_poi_fused_mul_3_xnumel = s85*s85
        stream0 = get_raw_stream(0)
        triton_poi_fused_mul_3.run(buf16, triton_poi_fused_mul_3_xnumel, stream=stream0)
        buf17 = buf13; del buf13  # reuse
        # Topologically Sorted Source Nodes: [mul_6, mul_7, add_5], Original ATen: [aten.mul, aten.add]
        triton_poi_fused_add_mul_4_xnumel = s36*s85
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_mul_4.run(buf17, buf15, triton_poi_fused_add_mul_4_xnumel, stream=stream0)
        ...
        extern_kernels.mm(buf18, reinterpret_tensor(buf18, (s36, s85), (1, s36), 0), out=buf19)
        ...
        triton_poi_fused_mul_3_xnumel = s85*s85
        stream0 = get_raw_stream(0)
        triton_poi_fused_mul_3.run(buf21, triton_poi_fused_mul_3_xnumel, stream=stream0)
        buf22 = buf18; del buf18  # reuse
        # Topologically Sorted Source Nodes: [mul_9, mul_10, add_7], Original ATen: [aten.mul, aten.add]
        triton_poi_fused_add_mul_4_xnumel = s36*s85
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_mul_4.run(buf22, buf20, triton_poi_fused_add_mul_4_xnumel, stream=stream0)
        ...
        extern_kernels.mm(buf23, reinterpret_tensor(buf23, (s36, s85), (1, s36), 0), out=buf24)
        ...
        triton_poi_fused_mul_3_xnumel = s85*s85
        stream0 = get_raw_stream(0)
        triton_poi_fused_mul_3.run(buf26, triton_poi_fused_mul_3_xnumel, stream=stream0)
        buf27 = buf23; del buf23  # reuse
        # Topologically Sorted Source Nodes: [mul_12, mul_13, add_9], Original ATen: [aten.mul, aten.add]
        triton_poi_fused_add_mul_4_xnumel = s36*s85
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_mul_4.run(buf27, buf25, triton_poi_fused_add_mul_4_xnumel, stream=stream0)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 768
    arg1_1 = 3072
    arg2_1 = rand_strided((768, 3072), (3072, 1), device='cuda:0', dtype=torch.float32)
