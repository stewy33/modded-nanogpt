...
# kernel path: /workspace/modded-nanogpt/.inductor_cache/3p/c3phvzr64egq56evchvodlqha63usfx2hjz3uoxteoeni6d5gkt4.py
# Topologically Sorted Source Nodes: [rms_norm, rms_norm_45, cat, cat_1], Original ATen: [aten._to_copy, aten.pow, aten.mean, aten.add, aten.rsqrt, aten.cat]
# Source node to ATen node mapping:
#   cat => cat
#   cat_1 => cat_1
#   rms_norm => add, convert_element_type_12, mean, pow_1, rsqrt
#   rms_norm_45 => add_1, convert_element_type_14, mean_1, pow_2, rsqrt_1
# Graph fragment:
#   %convert_element_type_12 : [num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_2, torch.float32), kwargs = {})
...
triton_per_fused__to_copy_add_cat_mean_pow_rsqrt_2 = async_compile.triton('triton_per_fused__to_copy_add_cat_mean_pow_rsqrt_2', '''
import triton
import triton.language as tl
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_cat_mean_pow_rsqrt_2', 'mutated_arg_names': ['in_out_ptr0', 'in_out_ptr1'], 'optimize_mem': False, 'no_x_dim': False, 'num_load': 14, 'num_reduction': 2, 'backend_hash': '0E240AAAE3E9D1980383EC2FCF1E55EF51BD69D1F11DF86C6B99F17FF7E9B37A', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 12582912, 'r0_': 2550136832}}
)
@triton.jit
def triton_per_fused__to_copy_add_cat_mean_pow_rsqrt_2(in_out_ptr0, in_out_ptr1, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 786432
    r0_numel = 128
...
# kernel path: /workspace/modded-nanogpt/.inductor_cache/gn/cgnywoxb6clwte7e5mfjk75re4gw26tqkyryivl6ofar3cl5gri3.py
# Topologically Sorted Source Nodes: [add_4, rms_norm_46, linear_4], Original ATen: [aten.add, aten.pow, aten.mean, aten.rsqrt, aten.mul, aten._to_copy]
# Source node to ATen node mapping:
#   add_4 => add_6
#   linear_4 => convert_element_type_20
#   rms_norm_46 => add_7, mean_2, mul_10, pow_3, rsqrt_2
# Graph fragment:
#   %add_6 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%primals_8, %view_11), kwargs = {})
...
#   %mul_10 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_6, %rsqrt_2), kwargs = {})
#   %convert_element_type_20 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_10, torch.bfloat16), kwargs = {})
triton_per_fused__to_copy_add_mean_mul_pow_rsqrt_3 = async_compile.triton('triton_per_fused__to_copy_add_mean_mul_pow_rsqrt_3', '''
import triton
import triton.language as tl
...
# kernel path: /workspace/modded-nanogpt/.inductor_cache/jp/cjp4tabk2ssgr5kuccwlxrbm4kh6vhkebhstil3pchy6sp7snp3l.py
# Topologically Sorted Source Nodes: [linear_4], Original ATen: [aten._to_copy, aten.t]
# Source node to ATen node mapping:
#   linear_4 => convert_element_type_19, permute_8
# Graph fragment:
#   %convert_element_type_19 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_9, torch.bfloat16), kwargs = {})
#   %permute_8 : [num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_19, [1, 0]), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_t_4', 'mutated_arg_names': [], 'optimize_mem': False, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': '0E240AAAE3E9D1980383EC2FCF1E55EF51BD69D1F11DF86C6B99F17FF7E9B37A', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 18874368}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /workspace/modded-nanogpt/.inductor_cache/ny/cnyihzaqmgzgrxbk4jvc77yyuw3bbrnisjgids4x75jguadqe6vn.py
# Topologically Sorted Source Nodes: [relu, square, linear_5], Original ATen: [aten.relu, aten._to_copy, aten.pow]
# Source node to ATen node mapping:
#   linear_5 => convert_element_type_25
#   relu => relu
#   square => convert_element_type_23, pow_4
# Graph fragment:
...
#   %pow_4 : [num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_23, 2), kwargs = {})
#   %convert_element_type_25 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%pow_4, torch.bfloat16), kwargs = {})
triton_poi_fused__to_copy_pow_relu_5 = async_compile.triton('triton_poi_fused__to_copy_pow_relu_5', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_pow_relu_5', 'mutated_arg_names': [], 'optimize_mem': False, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': '0E240AAAE3E9D1980383EC2FCF1E55EF51BD69D1F11DF86C6B99F17FF7E9B37A', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 2415919104}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused__to_copy_pow_relu_5(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 402653184
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /workspace/modded-nanogpt/.inductor_cache/gz/cgzuswh7ura3drviiozeoaamw7hdqseyk45ikfmw343qpzy2zeud.py
# Topologically Sorted Source Nodes: [add_4, add_5, rms_norm_47], Original ATen: [aten.add, aten.pow, aten.mean, aten.rsqrt, aten.mul]
# Source node to ATen node mapping:
#   add_4 => add_6
#   add_5 => add_8
#   rms_norm_47 => add_9, mean_3, mul_11, pow_5, rsqrt_3
# Graph fragment:
#   %add_6 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%primals_8, %view_11), kwargs = {})
#   %add_8 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_6, %view_15), kwargs = {})
...
#   %mul_11 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_8, %rsqrt_3), kwargs = {})
...
def call(args):
    ...
    assert_size_stride(primals_9, (3072, 768), (768, 1))
    assert_size_stride(primals_10, (768, 3072), (3072, 1))
    with torch.cuda._DeviceGuard(0):
        ...
        buf7 = empty_strided_cuda((128, 1024, 6, 1), (6144, 6, 1, 786432), torch.float32)
        buf8 = reinterpret_tensor(buf7, (128, 1024, 6, 1), (6144, 6, 1, 1), 0); del buf7  # reuse
        buf9 = empty_strided_cuda((128, 1024, 6, 1), (6144, 6, 1, 786432), torch.float32)
        buf10 = reinterpret_tensor(buf9, (128, 1024, 6, 1), (6144, 6, 1, 1), 0); del buf9  # reuse
        buf11 = empty_strided_cuda((128, 1024, 6, 128), (786432, 768, 128, 1), torch.bfloat16)
        buf12 = empty_strided_cuda((128, 1024, 6, 128), (786432, 768, 128, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [rms_norm, rms_norm_45, cat, cat_1], Original ATen: [aten._to_copy, aten.pow, aten.mean, aten.add, aten.rsqrt, aten.cat]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_cat_mean_pow_rsqrt_2.run(buf8, buf10, buf2, buf4, primals_5, primals_6, buf11, buf12, 786432, 128, stream=stream0)
        # Topologically Sorted Source Nodes: [scaled_dot_product_attention], Original ATen: [aten._scaled_dot_product_flash_attention]
        buf13 = torch.ops.aten._scaled_dot_product_flash_attention.default(reinterpret_tensor(buf11, (128, 6, 1024, 128), (786432, 128, 768, 1), 0), reinterpret_tensor(buf12, (128, 6, 1024, 128), (786432, 128, 768, 1), 0), reinterpret_tensor(buf6, (128, 6, 1024, 128), (786432, 128, 768, 1), 0), 0.0, True, scale=0.08838834764831843)
        buf14 = buf13[0]
        assert_size_stride(buf14, (128, 6, 1024, 128), (786432, 128, 768, 1), 'torch.ops.aten._scaled_dot_product_flash_attention.default')
        assert_alignment(buf14, 16, 'torch.ops.aten._scaled_dot_product_flash_attention.default')
        buf15 = buf13[1]
        assert_size_stride(buf15, (128, 6, 1024), (6144, 1024, 1), 'torch.ops.aten._scaled_dot_product_flash_attention.default')
        assert_alignment(buf15, 16, 'torch.ops.aten._scaled_dot_product_flash_attention.default')
        buf16 = buf13[6]
        assert_size_stride(buf16, (2, ), (1, ), 'torch.ops.aten._scaled_dot_product_flash_attention.default')
        assert_alignment(buf16, 16, 'torch.ops.aten._scaled_dot_product_flash_attention.default')
        buf17 = buf13[7]
        assert_size_stride(buf17, (), (), 'torch.ops.aten._scaled_dot_product_flash_attention.default')
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_t_0.run(primals_7, buf19, 589824, stream=stream0)
        del primals_7
        buf20 = empty_strided_cuda((131072, 768), (768, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_3], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf14, (131072, 768), (768, 1), 0), buf19, out=buf20)
        buf21 = empty_strided_cuda((128, 1024, 1), (1024, 1, 131072), torch.float32)
        buf22 = reinterpret_tensor(buf21, (128, 1024, 1), (1024, 1, 1), 0); del buf21  # reuse
        buf24 = empty_strided_cuda((128, 1024, 768), (786432, 768, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [add_4, rms_norm_46, linear_4], Original ATen: [aten.add, aten.pow, aten.mean, aten.rsqrt, aten.mul, aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_mean_mul_pow_rsqrt_3.run(buf22, primals_8, buf20, buf24, 131072, 768, stream=stream0)
        buf23 = empty_strided_cuda((768, 3072), (1, 768), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_4], Original ATen: [aten._to_copy, aten.t]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_t_4.run(primals_9, buf23, 2359296, stream=stream0)
        del primals_9
        buf25 = empty_strided_cuda((131072, 3072), (3072, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_4], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf24, (131072, 768), (768, 1), 0), buf23, out=buf25)
        buf26 = empty_strided_cuda((3072, 768), (1, 3072), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_5], Original ATen: [aten._to_copy, aten.t]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_t_4.run(primals_10, buf26, 2359296, stream=stream0)
        del primals_10
        buf27 = empty_strided_cuda((128, 1024, 3072), (3145728, 3072, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [relu, square, linear_5], Original ATen: [aten.relu, aten._to_copy, aten.pow]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_pow_relu_5.run(buf25, buf27, 402653184, stream=stream0)
        buf28 = empty_strided_cuda((131072, 768), (768, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_5], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf27, (131072, 3072), (3072, 1), 0), buf26, out=buf28)
        buf29 = empty_strided_cuda((128, 1024, 768), (786432, 768, 1), torch.float32)
        ...
        buf32 = empty_strided_cuda((128, 1024, 768), (786432, 768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [add_4, add_5, rms_norm_47], Original ATen: [aten.add, aten.pow, aten.mean, aten.rsqrt, aten.mul]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_mean_mul_pow_rsqrt_6.run(buf31, primals_8, buf20, buf28, buf29, buf32, 131072, 768, stream=stream0)
        del buf28
    return (buf32, primals_5, primals_6, primals_8, reinterpret_tensor(buf1, (131072, 768), (768, 1), 0), buf2, buf4, buf8, buf10, reinterpret_tensor(buf11, (128, 6, 1024, 128), (786432, 128, 768, 1), 0), reinterpret_tensor(buf12, (128, 6, 1024, 128), (786432, 128, 768, 1), 0), reinterpret_tensor(buf6, (128, 6, 1024, 128), (786432, 128, 768, 1), 0), buf14, buf15, buf16, buf17, buf20, buf22, reinterpret_tensor(buf24, (131072, 768), (768, 1), 0), buf25, reinterpret_tensor(buf27, (131072, 3072), (3072, 1), 0), buf29, buf31, reinterpret_tensor(buf26, (768, 3072), (3072, 1), 0), reinterpret_tensor(buf23, (3072, 768), (768, 1), 0), reinterpret_tensor(buf19, (768, 768), (768, 1), 0), reinterpret_tensor(buf5, (768, 768), (768, 1), 0), reinterpret_tensor(buf3, (768, 768), (768, 1), 0), reinterpret_tensor(buf0, (768, 768), (768, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_9 = rand_strided((3072, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    primals_10 = rand_strided((768, 3072), (3072, 1), device='cuda:0', dtype=torch.float32)
