...
#   %add_10 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%tangents_2, %mul_13), kwargs = {})
...
#   %add_11 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_10, %mul_17), kwargs = {})
#   %convert_element_type_28 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_11, torch.bfloat16), kwargs = {})
#   %view_16 : [num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%convert_element_type_28, [131072, 768]), kwargs = {})
...
#   %add_12 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_11, %mul_21), kwargs = {})
...
#   %add_13 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_12, %mul_25), kwargs = {})
#   %convert_element_type_42 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_13, torch.bfloat16), kwargs = {})
...
# Source node to ATen node mapping:
#   neg => neg
#   rms_norm_41 => convert_element_type_14
# Graph fragment:
...
#   %add_14 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_26, %mul_28), kwargs = {})
#   %mul_29 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%slice_9, %unsqueeze_1), kwargs = {})
#   %add_15 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_27, %mul_29), kwargs = {})
...
#   %convert_element_type_48 : [num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_16, torch.float32), kwargs = {})
...
#   %add_20 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_35, %mul_39), kwargs = {})
#   %convert_element_type_49 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_20, torch.bfloat16), kwargs = {})
...
#   %add_22 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_56, %convert_element_type_62), kwargs = {})
...
#   %add_23 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_22, %convert_element_type_68), kwargs = {})
...
def call(args):
    primals_5, primals_6, primals_8, view, mm, mm_1, rsqrt, rsqrt_1, permute_3, permute_4, permute_5, getitem, getitem_1, getitem_6, getitem_7, mm_3, rsqrt_2, view_12, mm_4, view_14, add_8, rsqrt_3, permute_12, permute_16, permute_20, permute_28, permute_32, permute_36, tangents_1, tangents_2 = args
    args.clear()
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        extern_kernels.mm(reinterpret_tensor(buf2, (768, 131072), (1, 768), 0), view_14, out=buf3)
        del view_14
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf6, (3072, 131072), (1, 3072), 0), view_12, out=buf7)
        del view_12
        ...
        # Topologically Sorted Source Nodes: [add_4], Original ATen: [aten._to_copy, aten.add, aten.mul, aten.sum, aten.div, aten.pow, aten.view]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_div_mul_pow_sum_view_3.run(buf11, buf8, primals_8, mm_3, rsqrt_2, buf12, 131072, 768, stream=stream0)
        del mm_3
        del primals_8
        del rsqrt_2
        ...
        # Topologically Sorted Source Nodes: [neg, rms_norm_41], Original ATen: [aten.mul, aten.neg, aten.add, aten.slice_backward, aten._to_copy, aten.sum, aten.div, aten.pow]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_div_mul_neg_pow_slice_backward_sum_5.run(buf27, buf18, primals_5, primals_6, rsqrt_1, 786432, 128, stream=stream0)
        del buf18
        del rsqrt_1
        ...
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_div_mul_neg_pow_slice_backward_sum_5.run(buf31, buf17, primals_5, primals_6, rsqrt, 786432, 128, stream=stream0)
        del primals_5
        del primals_6
        del rsqrt
        ...
        del buf32
    return (buf34, buf35, buf30, buf26, None, None, buf15, buf11, buf9, buf5, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    fn = lambda: call([primals_5, primals_6, primals_8, view, mm, mm_1, rsqrt, rsqrt_1, permute_3, permute_4, permute_5, getitem, getitem_1, getitem_6, getitem_7, mm_3, rsqrt_2, view_12, mm_4, view_14, add_8, rsqrt_3, permute_12, permute_16, permute_20, permute_28, permute_32, permute_36, tangents_1, tangents_2])
